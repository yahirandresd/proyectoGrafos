...
class Calle:
    ...
    def crear_calle(self):
        ...
        self.calle.add_edge(self.ubicaciones[0], self.ubicaciones[18])
        self.calle.add_edge(self.ubicaciones[0], self.ubicaciones[19])
        self.calle.add_edge(self.ubicaciones[19], self.ubicaciones[1])
        ...
        self.calle.add_edge(self.ubicaciones[16], self.ubicaciones[3])
        ...
        self.calle.add_edge(self.ubicaciones[5], self.ubicaciones[3])
        ...
        self.calle.add_edge(self.ubicaciones[12], self.ubicaciones[13])
        self.calle.add_edge(self.ubicaciones[13], self.ubicaciones[16])
        self.calle.add_edge(self.ubicaciones[13], self.ubicaciones[5])
        self.calle.add_edge(self.ubicaciones[13], self.ubicaciones[8])
